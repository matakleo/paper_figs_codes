...
for HN in HNS :
    ...
    for PBL in PBLS:
        ...
        # print(xticks)
        ax[row_count,col_count].set_title(HN,size=12)
...
ax[1,0].set_xlabel('SLP [mb]',size=12)
ax[1,1].set_xlabel('SLP [mb]',size=12)
ax[1,2].set_xlabel('SLP [mb]',size=12)
...
print('saved as: fig11_wspd_SLP_boxes'+fig_name+PBLS[0]+'.eps')
plt.savefig('/Users/lmatak/Desktop/leo_python_scripts/Paper_Figs/figs_saved/fig11_wspd_SLP_boxes'+fig_name+PBLS[0]+'.eps',bbox_inches='tight')
