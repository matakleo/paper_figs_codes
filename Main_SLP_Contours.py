...
HNS = ['Maria','Lorenzo','Teddy','Dorian','Iota','Igor']
        ...
        for TM in TMS:
            ...
            for PBL in PBLS:
                for CL in CLS: 
                    ...
                    ax[row,col].set_extent([slp_coord_long+0.96,slp_coord_long-0.96,slp_coord_lat-0.65,slp_coord_lat+0.65])
...
if CLS[0] == 'xkzm_0.125':
    ...
    ax[0,0].set_title('cl_km = 0.125', size=12)
    ax[0,1].set_title('Default Case',size=12)
    ax[0,2].set_title('cl_km = 8.0',size=12)
else:   
...
# fig.colorbar(im_cbar, ax=cbar_ax,location='right')
#, label = 'Wind Speed [m/s] at 500 m Above Sea-Level')
# cbar.set_label('wspd', rotation = 270, labelpad = 25, size = 'small')
# 

# plt.subplots_adjust(left=0.2, bottom=None, right=None, top=None, wspace=0.01, hspace=None)
# plt.show()
plt.savefig('/Users/lmatak/Desktop/leo_python_scripts/Paper_Figs/figure5_CONTOURS_lvls_MYJ.png',bbox_inches='tight')
