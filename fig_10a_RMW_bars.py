...
ax1.set_ylabel('RMW [km]',fontsize=12)
...
# plt.show()
print('saved as: fig10_RMW_bars'+name_text+'.eps')
plt.savefig('/Users/lmatak/Desktop/leo_python_scripts/Paper_Figs/figs_saved/fig10_RMW_bars'+name_text+'.eps',bbox_inches='tight')