...
print('saved as: fig7_min_slp_boxes'+fig_name+PBLS[0]+'.eps')
plt.savefig('/Users/lmatak/Desktop/leo_python_scripts/Paper_Figs/figs_saved/fig7_min_slp_boxes'+fig_name+PBLS[0]+'.eps',bbox_inches='tight')
# plt.show()